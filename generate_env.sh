...
LUMINAIRE_TCP_KEEPALIVE_ENABLED="$(get_yaml '.services.tcp.tcpserver.keepalive_enabled')"
LUMINAIRE_TCP_KEEPALIVE_IDLE_S="$(get_yaml '.services.tcp.tcpserver.keepalive_idle_s')"
LUMINAIRE_TCP_KEEPALIVE_INTERVAL_S="$(get_yaml '.services.tcp.tcpserver.keepalive_interval_s')"
LUMINAIRE_TCP_KEEPALIVE_COUNT="$(get_yaml '.services.tcp.tcpserver.keepalive_count')"
LUMINAIRE_TCP_USER_TIMEOUT_MS="$(get_yaml '.services.tcp.tcpserver.tcp_user_timeout_ms')"
